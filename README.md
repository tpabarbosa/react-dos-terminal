...
A collection of React Components to simulate a DOS command line interface.

![component screen shot](docs/main.png?raw=true)

Was created using [React](https://github.com/facebook/react) and [Typescript](https://github.com/Microsoft/TypeScript). It also uses [styled-components](https://github.com/styled-components/styled-components) and [Lodash](https://lodash.com/)...
...
Terminal component accepts an optional **config** object as a prop. In this config object you can define custom commands, files and directories and some other attributes. All attributes are optionals:
...
| _loadingScreen_          | **loadingTime**             |                                                                                                                                           Set for how long time, in miliseconds, the loading screen should be displayed                                                                                                                                            | `5000`                                                                                                                                                                                                                                                                                                                            |
...
In the case you have to do some async operation, you should use the `async` attribute to indicate to terminal that it has to wait for the command to complete.
...
```ts
{
    ...
    async: { waitingMessage: ['Getting something that takes some time...'] } // you can just pass async: {} and no waitingMessage will be outputed
}
```
